...
export default CreateTripScreen = ({ navigation }) => {
  ...
  //       if (responseBody || responseBody.body.unregistered_participants) {
  //         const unregisteredParticipants =
  //           responseBody.body.unregistered_participants;
  //         Alert.alert(
  //           "Warning",
  //           `The following participants are not registered: ${unregisteredParticipants}`
  //         );
  //       }
  ...
  //         !responseBody.body.unregistered_participants
  //       ) {
  //         Alert.alert("Created Trip Successfully.", responseBody.body.message);
  //         navigation.navigate("Home");
  //       } else if (
  //         response.status === 400 &&
  //         responseBody &&
  ...
  //         Alert.alert(
  //           "Warning",
  //           responseBody && responseBody.body && responseBody.body.message
  //             ? responseBody.body.message
  //             : "Warning message."
  //         );
  //         navigation.navigate("Home");
