...
const GetMatchedScreen = ({ navigation }) => {
  ...
  async function getMatched() {
    if (dates.length > 0 || countries.length > 0) {
      await putUserPref(email, dates, countries).then((status) => {
            ...
            <View style={{ alignItems: "center" }}>
              <View>
                ...
                <Text style={styles.message}>
                  This enables us to match you with others going to the same
                  country at the same dates as you.
                </Text>
              </View>
              ...
              <SelectManyDates
                ...
                label={
                  "Eg. If you’re going to Greece on 21-28 June and Mexico on 10-17 July, add all the dates below"
                }
